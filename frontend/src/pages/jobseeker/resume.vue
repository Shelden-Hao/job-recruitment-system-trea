    ...
    <view class="resume-card">
      ...
      <view class="basic-info">
        <view class="info-item">
          ...
          <text class="value">{{ resume.name }}</text>
        </view>
        <view class="info-item">
          <text class="label">年龄</text>
          <text class="value">{{ resume.age }}岁</text>
        </view>
        <view class="info-item">
        ...
        <view class="info-item">
          ...
          <text class="value">{{ resume.phone }}</text>
        </view>
        <view class="info-item">
          <text class="label">邮箱</text>
          <text class="value">{{ resume.email }}</text>
        </view>
      </view>
      ...
      <view class="intention-info">
        <view class="info-item">
          ...
          <text class="value">{{ resume.intention.position }}</text>
        </view>
        <view class="info-item">
          <text class="label">期望薪资</text>
          <text class="value">{{ resume.intention.salary }}</text>
        </view>
        <view class="info-item">
          <text class="label">期望城市</text>
          <text class="value">{{ resume.intention.city }}</text>
        </view>
      </view>
      ...
      <view class="experience-list">
        <view v-for="(exp, index) in resume.experiences" :key="index" class="experience-item">
