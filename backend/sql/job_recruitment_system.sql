...
VALUES (1, 1, 1, '2024-01-15 10:30:00', 'pending', '/path/to/zhangsan_resume.pdf', '/path/to/zhangsan_coverletter.pdf',
        NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
INSERT INTO `applications`
VALUES (2, 1, 2, '2024-01-14 15:20:00', 'interview', '/path/to/zhangsan_resume.pdf', NULL, '2024-01-20 14:30:00',
...
VALUES (1, '科技有限公司', '/static/company-logo.png', '100-500人', '互联网', '一家快速发展的科技公司，致力于创新。',
        '深圳', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
INSERT INTO `companies`
VALUES (2, '互联网科技有限公司', '/static/company-logo.png', '1000+人', '互联网', '领先的互联网服务提供商。', '北京',
        '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
INSERT INTO `companies`
VALUES (3, '创新科技公司', '/static/company-logo.png', '20-50人', '互联网', '一家充满活力的创新科技公司。', '上海',
        '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
INSERT INTO `companies`
VALUES (4, '智能科技公司', NULL, '500-1000人', '人工智能', '专注于人工智能领域的研发和应用。', '广州',
        '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
INSERT INTO `companies`
VALUES (5, '大数据科技公司', NULL, '100-200人', '大数据', '提供大数据解决方案和服务的科技公司。', '杭州',
        '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL);
...
VALUES (1, 1, '前端开发工程师',
        '负责公司前端项目的开发和维护\n2. 与产品、设计和后端团队紧密协作\n3. 优化前端性能，提升用户体验\n4. 参与技术方案设计和评审',
        '深圳', '15k-25k', '2024-01-10 09:00:00', '3-5年', '本科及以上', 'React, Vue, 前端开发');
INSERT INTO `jobs`
VALUES (2, 2, '后端开发工程师', '负责后端开发，参与项目架构设计和优化。', '北京', '20k-30k', '2024-01-08 14:00:00',
        '3-5年', '本科及以上', 'Java, Spring, MySQL, 分布式');
INSERT INTO `jobs`
VALUES (3, 3, 'UI设计师', '负责产品界面和用户体验设计，提供高质量的设计方案。', '上海', '12k-18k', '2024-01-05 10:00:00',
        '2年以上', '本科及以上', 'UI设计, UX设计, Figma, Sketch');
INSERT INTO `jobs`
VALUES (4, 4, '产品经理', '负责产品规划、设计和项目推进，关注用户体验。', '广州', '18k-25k', '2024-01-03 16:00:00',
        '2年以上', '本科及以上', '产品设计, 项目管理, 用户体验');
INSERT INTO `jobs`
VALUES (5, 5, '数据分析师', '负责数据收集、整理、分析，为业务决策提供支持。', '杭州', '15k-22k', '2024-01-02 11:00:00',
        '1-3年', '本科及以上', '数据分析, SQL, Python, Tableau');
...
(
    ...
    `education`         varchar(255) NULL COMMENT '教育背景，包含学校、专业、学历、起止时间等',
    `experience`        varchar(255) NULL COMMENT '工作经验，包含公司、职位、起止时间、职责描述等',
    `skills`            varchar(255) NULL COMMENT '技能列表，包含技能名称和熟练度',
    `resume_url`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '简历文件路径',
    `expected_salary`   varchar(255) NULL DEFAULT NULL COMMENT '期望薪资（月薪）',
...
VALUES ('e227cb16-1419-48d3-8004-7699ab6423e8', '12', 'jobseeker1', '男', '2005-04-13', '"本科"', '"1年工作经验"',
        '"1. 熟练使用Vue.js"', '', '"15K-25k"', '"前端开发工程师"', '"深圳"', '"我是一名学习前端两年半的大学生。"',
        '2025-04-06 07:48:46', '2025-04-06 07:48:46', NULL);
...
-- ----------------------------
INSERT INTO `users`
VALUES (1, 'zhangsan', '$2a$10$passwordhash123', 'seeker', 'zhangsan@example.com', '13800138000', '2025-04-05 16:39:34',
        NULL, NULL, '张三', '/static/images/default-avatar.png', '求职者，期望从事前端开发相关工作。');
INSERT INTO `users`
VALUES (2, 'lisi', '$2a$10$anotherhash456', 'recruiter', 'lisi@example.com', '13987654321', '2025-04-05 16:39:34', NULL,
        2, '李四', '/static/images/default-avatar.png', '招聘者，负责公司技术人才招聘。');
INSERT INTO `users`
VALUES (3, 'wangwu', '$2a$10$yetanotherhash789', 'admin', 'wangwu@example.com', '13322223333', '2025-04-05 16:39:34',
        NULL, NULL, '王五', '/static/images/default-avatar.png', '管理员。');
INSERT INTO `users`
VALUES (4, 'zhaoliu', '$2a$10$zhaoliuhash', 'recruiter', 'zhaoliu@example.com', '13322224444', '2025-04-05 16:39:34',
        NULL, 1, '赵六', '/static/images/default-avatar.png', '负责公司招聘');
INSERT INTO `users`
VALUES (12, 'jobseeker1', '$2a$10$O7fnKJMFYK4GcyGhHDNA5OVzhPuHYBgcsQ3s846xjLmUalSEcEAJ2', 'jobseeker',
        'jobseeker1@example.com', NULL, '2025-04-06 15:48:46', '2025-04-06 15:48:46', NULL, NULL, NULL, NULL);
